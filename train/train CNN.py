...
def show_coverage(model):
    ...
    print('layer CNN ', 1, ' SAC: ', SAC_CNN(model.features[4].weight, h2_scrub_row, h2_scrub_col),
          ' SAC_ : ', SAC_CNN_(model.features[4].weight, h2_non_scrub_row, h2_non_scrub_col))
    print('layer CNN ', 1, ' SAC: ', SAC_CNN(model.features[8].weight, h3_scrub_row, h3_scrub_col),
          ' SAC_ : ', SAC_CNN_(model.features[8].weight, h3_non_scrub_row, h3_non_scrub_col))

    print('layer FC ', 1, ' SAC: ', SAC(weight=model.classifier[3].weight, d=args.d),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.0006, metavar='Learning rate', help='learning rate (default: 0.006)')
    parser.add_argument('--d', type=float, default=0, metavar='Diagonal', help='diagonal (default: 9)')
    parser.add_argument('--penalty_rate', '--wd', default=1e2, type=float, help='penalty rate (default: 1e1)')
